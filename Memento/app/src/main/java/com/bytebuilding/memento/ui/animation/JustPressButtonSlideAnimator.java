...
public class JustPressButtonSlideAnimator implements IntroAnimator {
    ...
    public void animateSlide(View page, float position) {
        ...
        TextView mDescription = (TextView) page.findViewById(R.id.tv_description_just_press_button);
