...
public class AnimatableTextView extends TextView {
    ...
    public static final String TAG = AnimatableTextView.class.getSimpleName();
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.AnimatableTextView);
        mColorSpace = typedArray.getDimension(R.styleable.AnimatableTextView_colorSpace, DisplayUtils.dp2px(150));
        mColorSpeed = typedArray.getDimension(R.styleable.AnimatableTextView_colorSpeed, DisplayUtils.dp2px(5));
        typedArray.recycle();
